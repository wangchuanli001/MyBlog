...
CREATE TABLE `article`  (
  ...
  `lastArticleId` bigint(0) NULL DEFAULT NULL,
  `nextArticleId` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `comment_record` VALUES (16, 0, 1532884460, 1, 1, '2020-02-27 16:03', 0, '1234', 0);
INSERT INTO `comment_record` VALUES (17, 0, 1532884460, 1, 1, '2020-02-27 16:13', 0, '1234565', 0);
INSERT INTO `comment_record` VALUES (18, 0, 1532884460, 16, 1, '2020-02-27 16:13', 0, '234', 1);
...
INSERT INTO `leave_message_record` VALUES (19, 'update', 0, 16, 1, '2020-02-27 16:13', 0, '123', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '18656888661', '王传礼', 'a3caed36f0fe5a01e5f144db8927235e', 'male', '王传礼', '1997-07-05', '978252321@qq.com', '', 'https://wangcl-wcl.oss-cn-hangzhou.aliyuncs.com/public/user/avatar/王传礼/1582791281.jpeg', '2020-02-27 16:14:21');
INSERT INTO `user` VALUES (16, '18656888662', 'coder丶', 'a3caed36f0fe5a01e5f144db8927235e', 'female', NULL, NULL, NULL, NULL, 'img/user/noLogin_female.jpg', '2020-02-27 16:13:17');
