    ...
    public EmbeddedServletContainerCustomizer containerCustomizer(){
        ...
        return new EmbeddedServletContainerCustomizer() {
            ...
            public void customize(ConfigurableEmbeddedServletContainer container) {
                ...
                ErrorPage error408Page = new ErrorPage(HttpStatus.REQUEST_TIMEOUT, "/404");
                ErrorPage error500Page = new ErrorPage(HttpStatus.INTERNAL_SERVER_ERROR, "/500");
                ErrorPage error502Page = new ErrorPage(HttpStatus.BAD_GATEWAY,"/404");

                container.addErrorPages(error400Page,error401Page,error404Page,error403Page,error408Page,error500Page,error502Page);
            }
        };
    }
