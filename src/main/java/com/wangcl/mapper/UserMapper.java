package com.wangcl.mapper;

import com.wangcl.model.Role;
...
public interface UserMapper {
    ...
    @Results({
            ...
            @Result(column = "phone", property = "roles", javaType = List.class, many = @Many(select = "com.wangcl.mapper.UserMapper.getRoleNameByPhone")),
    })
